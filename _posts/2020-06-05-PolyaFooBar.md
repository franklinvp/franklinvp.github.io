...
$$Z(G_1\times G_2,s_1,s_2,\ldots,s_{n_1\cdot n_2}) = Z(G_1,s_1,\ldots,s_{n_1})\textreferencemark Z(G_1,s_1,s_2,\ldots,s_{n_2})$$
...
$$f(x_1,x_2,\ldots,x_m)\textreferencemark g(x_1,x_2,\ldots,x_n)=\sum a_{i_1i_2\ldots i_m}b_{j_1j_2\ldots j_n}\times\prod_{\substack{1\leq r\leq m\\1\leq s\leq n}}(x_{r}^{i_l}\textreferencemark x_{s}^{j_s})$$

and 

$$x_{r}^{i_l}\textreferencemark x_{s}^{j_s} = x_{\lcm(r,s)}^{\gcd(r,s)i_rj_s}$$
